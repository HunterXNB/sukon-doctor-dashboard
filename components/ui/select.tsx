...
export const SelectPlaceholder = function ({
  children,
}: {
  children: React.ReactNode;
}) {
  return <span className="text-[#6c6c89]">{children}</span>;
};
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      <span className="absolute rtl:right-2 ltr:left-2 flex h-3.5 w-3.5 items-center justify-center">
